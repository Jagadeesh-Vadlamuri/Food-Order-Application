    ...
    <div className="container">
      <div className="row">
        <form onSubmit={formik.handleSubmit}>
          ...
          <Link to="/getItems" className="btn btn-secondary mx-2">Show All Items</Link>
          </div>
          {isOpen && (
            <Popup
              ...
              content={
                <div className="d-flex flex-column justify-content-start align-items-start">
                  ...
                  <h4 className="mt-3">Click on <span style={{color:'gray'}}>Show All Items</span> button below to see the created item</h4>
                  <div className="mt-3">
                    <button
                    ...
                    <Link to="/getItems" className="btn btn-secondary mt-4 mx-2">Show All Items</Link>
                  </div>
                </div>
              }
            />
